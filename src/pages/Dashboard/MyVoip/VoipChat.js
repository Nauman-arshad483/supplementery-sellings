...
import ChatBox from "../CustomerService/ChatBox";
import ScreenShare from "../CustomerService/ScreenShare";

const VoipChat = () => {
  const roles = [
    { title: "Client", selected: true },
    { title: "Admin", selected: false },
    { title: "Customer Service", selected: false },
  ];

  return (
    <div className="relative">
      <NavigateButton left={true} to="/store-owner/home" />
      <NavigateButton to="/customer-service/chat" />
      <div className="px-3">
        ...
        <p className="mt-5">
          You can choose who are you going to chat with (Client, Admin, or
          Customer Service) and find a list of people on the left hand side.
        </p>
      </div>
    </div>
  );
