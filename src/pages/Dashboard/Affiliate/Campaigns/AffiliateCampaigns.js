    ...
    <div className="p-5 bg-gray-50 my-10">
              ...
              {[
                {
                  ...
                  to: "/affiliate/campaigns/edit-campaigns",
                },
                {
                  id: 2,
              ...
              {[
                {
                  ...
                  to: "/affiliate/campaigns/invite-promoters",
                },
                {
                  id: 2,
                  btnName: "Add promoters",
                  to: "/affiliate/campaigns/add-promoters",
                },
                {
                  id: 3,
                  btnName: "Move promoters",
                  to: "/affiliate/campaigns/move-promoters",
                },
                {
                  id: 4,
      ...
      <div className="lg:flex gap-10">
        <div className="lg:w-1/2 w-full">
          ...
          <div className="md:flex pt-5 text-md text-xs">
