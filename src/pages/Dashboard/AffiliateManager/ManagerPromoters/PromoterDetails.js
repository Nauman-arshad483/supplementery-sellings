...
const PromoterDetails = () => {
  ...
  return (
    <div className="text-accent">
      ...
      <div className="bg-[#F7FAFC] md:flex p-5 border-b-2">
            ...
            <div className="flex items-center gap-5 cursor-pointer">
              ...
              <div className="border-l-2 pl-2 flex justify-center items-center gap-3">
                <img
                  ...
                  alt=""
                />
                <p className="text-blue-500">Add note</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-wrap gap-1 font-semibold">
          {buttonsLeft.map((btn) => (
            <button
              ...
              className={` md:px-5 px-3 text-gray-500 border-b-4 md:text-[15px] text-xs ${
