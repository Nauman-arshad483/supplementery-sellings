...
const ManagerPromotionsTable = ({ promotionsData }) => {
  return (
...
export default ManagerPromotionsTable;
        ...
        {[
          {
            ...
            to: "/affiliate-manager/promotions/edit-promotion",
          },
          {
            id: 2,
            btnName: "Add lead",
            to: "/affiliate-manager/promotions/add-lead",
          },
          {
            id: 3,
            btnName: "Remove",
            to: "/affiliate-manager/promotions/",
          },
          {
            id: 4,
            btnName: "Block/ban",
