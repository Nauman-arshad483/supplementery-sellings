...
const DisapprovedModal = () => {
  return (
    <div>
      ...
      <div className="modal ">
        <div className="w-11/12 max-w-3xl md:max-h-screen max-h-[600px] overflow-y-auto relative bg-white md:px-24 md:py-10 py-5">
          <label
          ...
          <div className="text-gray-400 text-center mb-10 p-5">
            <h1 className="text-gray-500 md:text-3xl text-2xl mb-5">
