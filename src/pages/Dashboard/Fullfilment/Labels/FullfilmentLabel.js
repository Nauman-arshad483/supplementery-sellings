...
const FullfilmentLabel = () => {
  ...
  const [selectedLabels, setSelectedLabels] = useState(allLabels.slice(0, 5));
  const handleLabelShow = (btn) => {
    if (btn.show === "all") {
      setSelectedLabels(allLabels.slice(0, 5));
    } else {
      setSelectedLabels(allLabels.filter((l) => l.status === btn.show));
    }
    ...
    <div>
      ...
      <div className="md:mb-10 mb-0 md:ml-20 ml-5">
        ...
        <p className="text-red-500">
          You have 5 labels waiting for your approval!
        </p>
      </div>
      <div className="bg-[#ECF2F7] mt-2 m-0 -mx-5 md:p-10 p-5">
        ...
        <div className="bg-white p-5 md:flex justify-between items-start">
          <h1 className="text-sm text-gray-400">Here are all the labels</h1>
...
export default FullfilmentLabel;
